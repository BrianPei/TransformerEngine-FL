...
if [ "${PLATFORM:-}" = "musa" ] || [ "${PLATFORM:-}" = "mthreads" ]; then
    ONNX_FILTER="test_export_layernorm_recipe or test_export_layernorm_zero_centered_gamma or test_export_layernorm_normalization or (test_export_core_attention and not arbitrary) or test_export_ctx_manager"
