...
def test_gemm_standard_and_device_mismatch():
    ...
    res, _, _, _ = general_gemm_torch(
        A=A, transA=True, B=B, transB=False, D=None, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=False, gelu_in=None, grad=False,
        workspace=A, workspace_size=0, accumulate=False, use_split_accumulator=False
    )
...
def test_gemm_3d_tensor_reshaping():
    ...
    res, _, _, _ = general_gemm_torch(
        A=A, transA=True, B=B, transB=False, D=None, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=False, gelu_in=None, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=False, use_split_accumulator=False
    )
...
def test_gemm_fp8_precision_downcast():
    ...
    res, _, _, _ = general_gemm_torch(
        A=A, transA=False, B=B, transB=False, D=None, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=False, gelu_in=None, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=False, use_split_accumulator=False
    )
...
def test_gemm_fusions_and_scaling():
    ...
    res, _, _, _ = general_gemm_torch(
        A=A, transA=False, B=B, transB=False, D=None, quantizer=None, 
        output_dtype=5, # 5 maps directly to torch.float16
        bias=bias, bias_type=None, gelu=False, gelu_in=None, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=False, use_split_accumulator=False,
        alpha=2.0  # Scales output before adding bias
    )
...
def test_gemm_gelu_activation_branches():
    ...
    res_a, _, gelu_in_a, _ = general_gemm_torch(
        A=A, transA=False, B=B, transB=False, D=None, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=True, gelu_in=None, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=False, use_split_accumulator=False
    )
    ...
    res_b, _, gelu_in_b, _ = general_gemm_torch(
        A=A, transA=False, B=B, transB=False, D=None, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=True, gelu_in=gelu_buffer, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=False, use_split_accumulator=False
    )
...
def test_gemm_accumulator_destinations():
    ...
    res_a, _, _, _ = general_gemm_torch(
        A=A, transA=False, B=B, transB=False, D=D_a, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=False, gelu_in=None, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=True, use_split_accumulator=False
    )
    ...
    res_b, _, _, _ = general_gemm_torch(
        A=A, transA=False, B=B, transB=False, D=D_b, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=False, gelu_in=None, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=True, use_split_accumulator=False,
        beta=0.5
    )
    ...
    res_c, _, _, _ = general_gemm_torch(
        A=A, transA=False, B=B, transB=False, D=D_c, quantizer=None, output_dtype=None,
        bias=None, bias_type=None, gelu=False, gelu_in=None, grad=False,
        workspace=torch.empty(1), workspace_size=0, accumulate=False, use_split_accumulator=False
    )
    assert res_c is D_c
